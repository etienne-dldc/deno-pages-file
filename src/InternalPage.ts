...
export type InternalPageAny = InternalPage<IBlocksFixedAny>;

export class InternalPage<HeaderBlocks extends IBlocksFixedAny> {
  ...
  public readContent(start?: number, length?: number): Uint8Array {
    return this.blocks.readRest(start, length);
  }

  public writeContent(content: Uint8Array, start?: number): void {
    this.blocks.writeRest(content, start);
  }
...
export class InternalRootPage extends InternalPage<typeof ROOT_HEADER_BLOCKS> {
...
export class InternalEmptylistPage
  extends InternalPage<typeof EMPTYLIST_HEADER_BLOCKS> {
...
export class InternalDataPage extends InternalPage<typeof DATA_HEADER_BLOCKS> {
  constructor(
    pageSize: number,
    addr: number,
    buffer: Uint8Array,
...
export class InternalEntryPage
  extends InternalPage<typeof ENTRY_HEADER_BLOCKS> {
  constructor(
    pageSize: number,
    addr: number,
    buffer: Uint8Array,
